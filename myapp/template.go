...
func allMovies(w http.ResponseWriter, r *http.Request) {
	...
	err = t.Execute(w, page{Title: "Movies", Navbar: "movies", Movies: ReadAllMovies()}) //execute the template and pass it the HomePageVars struct to fill in the gaps
	if err != nil {                                                                      // if there is an error
		log.Print("template executing error: ", err) //log it
	}
}
...
func allSeries(w http.ResponseWriter, r *http.Request) {
	...
	err = t.Execute(w, page{Title: "Series", Navbar: "series", Series: ReadAllSeries()}) //execute the template and pass it the HomePageVars struct to fill in the gaps
	if err != nil {                                                                      // if there is an error
		log.Print("template executing error: ", err) //log it
	}
}
